// data.jsx — Palanga VR pabėgimo kambarių katalogas (lietuvių k.)
const GAMES = [
  {
  ...
  },
  {
    ...
    description: [
      ...
      'Kovokite su kitais piratais, spręskite gavosūkius! Aktyvus ir intensyvus! Puikiai tinka norintiems azarto ir veiksmo. Rekomenduojama šeimoms.',
  ...
  },
  {
    ...
    tags: ['Po vandeniu', 'Paslaptis', 'Įtampa', 'Komandinis']
  },
  {
...
// Pricing – flat group rate. "Nuo 20€ / žmogui" headline.
const PRICING = [
...
Object.assign(window, { GAMES, PRICING, FAQ_ITEMS });
